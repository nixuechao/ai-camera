...
@Component
@Slf4j
public class PropertyAsyncProvider implements SubMessageProcessProvider {
    @Override
    public <T> void process(String clientId, String requestId, Message<T> message) {
        log.info("属性异步应答,client:{},request:{}", clientId, requestId);
    ...
    public SubTopicEnum supportTopic() {
        return SubTopicEnum.SUB_PROPERTY_ASYNC;
    }
